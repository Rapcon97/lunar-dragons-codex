...
const astropathicMessageTemplates = [
  { agency: "Adeptus Terra", subject: "Compliance return overdue", preview: "Confirm the present disposition of the Argent Vigil and all systems restored under the Nachmund Charge.", body: "Chapter Master, the strategic command archive has not received the current compliance return required under warrant 008.M42/DR-017. Submit the disposition of the Lunar Dragons, the status of every system restored under the Nachmund Charge, and the location of the Gift of Luna. Any omission will be entered as a failure of record, not of service.", priority: "PRIMUS" },
  ...
  { agency: "Administratum", subject: "Founding rolls discrepancy", preview: "Three gene-seed tithe entries remain unverified against the Ultima Founding registry. Clarification is required.", body: "A discrepancy has been identified between the Ultima Founding registry and three gene-seed tithe entries attributed to the Lunar Dragons. The seals are authentic but the vessel names do not correspond with surviving fleet rolls. Provide the Apothecarion's countersign, chain of custody and present disposition of the disputed vaults.", priority: "NOTICE" },
  ...
  { agency: "Ordo Hereticus", subject: "Restricted witness transfer", preview: "A protected witness recovered from Selene Prime must be conveyed to the Chapter fleet under absolute silence.", body: "A protected witness recovered beneath Hive Enoch must be transferred to the Lunar Dragons fleet under absolute silence. The subject bears knowledge of a cult network extending beyond Selene Prime. No local authority is to be informed. Provide a secure rendezvous and a squad whose loyalty is beyond question.", priority: "PRIMUS" },
